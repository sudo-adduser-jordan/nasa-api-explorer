...
// const roverManifest = `https://api.nasa.gov/mars-photos/api/v1/manifests/${id}?api_key=DEMO_KEY`;
...
//         `https://api.nasa.gov/mars-photos/api/v1/rovers/${id}/photos?api_key=DEMO_KEY&sol=${max_sol}`
//     );
//     const data: Root = await res.json();
...
// RoverPage.getLayout = function getLayout(page: React.ReactElement) {
//     return (
//         <Layout>
